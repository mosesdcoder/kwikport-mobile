...
//       // Fetch substages for ALL 5 main stages
...
//     // for (int i = 1; i <= _stageTitles.length; i++) {
//     //   await _fetchStage(i);
//     // }
//   }
...
//   //   // Store fetched subStages for this stage only
//   //   setState(() {
//   //     stageSubStages[mainStage] = List.from(api.subStages);
//   //   });
...
//   //     _unlockNextStage(3);
//   //     setState(() {
//   //       stageStates[0] = StageStatus.completed;
//   //     });
//   //   }
//   //   if (mainStage == 3 && allCompleted) _unlockNextStage(4);
//   //   if (mainStage == 4 && allCompleted) _unlockNextStage(5);
//   //   if (mainStage == 5 && allCompleted) _unlockNextStage(6);
//   // }
//   Future<void> _fetchStage(int mainStage) async {
//     final api = Provider.of<ExportSubStageApi>(context, listen: false);
...
//       final fetchedSubStages = List<ExportSubStageModel>.from(api.subStages);
...
//       final allCompleted = fetchedSubStages.every(
//         (s) => s.isCompleted ?? false,
//       );
//       final anyActive = fetchedSubStages.any((s) => s.isActive ?? false);

//       if (allCompleted) {
//         setState(() => stageStates[mainStage - 1] = StageStatus.completed);
//         _unlockNextStage(mainStage + 1);
//       } else if (anyActive) {
//         setState(() => stageStates[mainStage - 1] = StageStatus.inProgress);
//       }

//       print(
//         "✅ Loaded MainStage $mainStage with ${fetchedSubStages.length} substages",
//       );
//     } catch (e) {
//       print("❌ Failed to fetch substages for stage $mainStage: $e");
//     }
//   }
...
// // class ExportJourney extends StatefulWidget {
// //   const ExportJourney({super.key});

// //   @override
// //   State<ExportJourney> createState() => _ExportJourneyState();
// // }

// // class _ExportJourneyState extends State<ExportJourney> {
// //   @override
// //   Widget build(BuildContext context) {
// //     return Scaffold(
// //       extendBody: true,
