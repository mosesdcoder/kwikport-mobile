                  ...
                  Column(
                    children: [
                        ...
                        child: RichText(
                          ...
                          text: TextSpan(
                            ...
                            children: [
                              ...
                              TextSpan(
                                text:
                                    "${(widget.contract.totalQuantity ?? 0) - (widget.contract.fulfilledQuantity ?? 0)} tons",
                              ),
                            ],
                          ),
                        ),
                      ...
                      kwikbutton("Generate Ticket", () async {
                        ...
                        debugPrint(
                          '  exporterUniqueId: \t\t${userDataVar?.exporterUniqueId}',
                        );
                        debugPrint(
                        ...
                        debugPrint(
                          '  otherNames: \t\t${userDataVar?.otherNames}',
                        );
                        debugPrint('  email: \t\t${userDataVar?.email}');
                        debugPrint(
                          '  phoneNumber: \t\t${userDataVar?.phoneNumber}',
                        );
