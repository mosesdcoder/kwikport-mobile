...
class BussinessInformation extends StatefulWidget {
  ...
  final Function(String?) onExportExperienceChanged;
  ...
  const BussinessInformation({
    ...
    required this.typeOfBusinessController,
    required this.exportExperience,
    required this.onExportExperienceChanged,
  });
...
class _BussinessInformationState extends State<BussinessInformation> {
  ...
  void initState() {
    super.initState();
    widget.businessNameController.addListener(_validateForm);
    widget.typeOfBusinessController.addListener(_validateForm);
    widget.businessAddressController.addListener(_validateForm);
    widget.businessRegNumberController.addListener(_validateForm);
  }

  @override
  void dispose() {
    widget.businessNameController.removeListener(_validateForm);
    widget.typeOfBusinessController.removeListener(_validateForm);
    widget.businessAddressController.removeListener(_validateForm);
    widget.businessRegNumberController.removeListener(_validateForm);
    super.dispose();
  }
  ...
  void _validateForm() {
    final isValid =
        ...
        widget.typeOfBusinessController.text.isNotEmpty &&
        widget.businessAddressController.text.isNotEmpty &&
        widget.exportExperience != null; // dropdown check
              ...
              child: Column(
                children: [
                  ...
                  kycnameFieldColumn(
                    "Type of Business",
                    "",
                    widget.typeOfBusinessController,
                    hintText: "Exporting",
                  ),
                  SizedBox(height: 8),
                  ...
                  SizedBox(
                    ...
                    child: kycnameFieldColumn(
                      "Business Address",
                      "",
                      widget.businessAddressController,
                      hintText: "123 Main Street, Lagos",
                      maxLines: 5,
                      // maxLength: 200,
                    ),
